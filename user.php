        ...
        <div class="container-header">
            ...
            <nav>
                <div class="container-a">
                    <a href="user.php" class="a-nav">Beranda</a>
                    ...
                    <div class="container-surface1">
                        ...
                        <div class="btn-content1">
                            ...
                            <div class="container-secodry">
                                <a href="#tentang" class="btn-secondry">Tentang
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5a3e2b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-store-icon lucide-store">
            ...
            <div class="container-card-product">
                ...
                <div class="card-product1">
                    ...
                    <div class="container-deksripsi">
                        ...
                        <a href="pesanan.php" class="btn-pesan">
                            <p>Pesan</p>
                        </a>
                    </div>
                </div>
                ...
                <div class="card-product1">
                    ...
                    <div class="container-deksripsi">
                        ...
                        <a href="pesanan.php" class="btn-pesan" id="layanan">
                            <p>Pesan</p>
                        </a>
                    </div>
                </div>
